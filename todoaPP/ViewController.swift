...
// 테이블뷰의 데이터 매칭 - getnews()에서 받아온 문자열을 어떻게 넘기는가?


// background 쪽에서 네트워크가 굴러감
// ui를 그리는건 메인에서 해야함
...
//    }
    ...
    func getNews() {
        let task = URLSession.shared.dataTask(with: URL(string: "https://newsapi.org/v2/top-headlines?country=kr&apiKey=ef95d51aed684dbcb3c94ce53d50cd20")!) { (data, response, error) in
